...
class CategoriesNewsDetails extends StatefulWidget {
  ...
  @override
  State<CategoriesNewsDetails> createState() => _CategoriesNewsDetailsState();
}

class _CategoriesNewsDetailsState extends State<CategoriesNewsDetails> {
